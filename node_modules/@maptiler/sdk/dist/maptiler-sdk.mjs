...
function ot(r) {
  if (r === null || typeof r == "string" || typeof r == "boolean" || typeof r == "number" || r instanceof ie || r instanceof F || r instanceof Ur || r instanceof me || r instanceof Q || r instanceof ee || r instanceof X || r instanceof ue || r instanceof Ee)
    return !0;
  if (Array.isArray(r)) {
    for (const e of r)
      if (!ot(e))
    ...
    r.addLayer(
      {
        ...
        paint: {
          ...
          "circle-radius": typeof e.pointRadius == "number" ? e.pointRadius : Array.isArray(e.pointRadius) ? z(e.pointRadius) : $r(L, "point_count", !1),
